...
class ProjectDetailsDesktop extends StatefulWidget {
  final int projectId;
  ...
  @override
  State<ProjectDetailsDesktop> createState() => _ProjectDetailsDesktopState();
}

class _ProjectDetailsDesktopState extends State<ProjectDetailsDesktop> {
