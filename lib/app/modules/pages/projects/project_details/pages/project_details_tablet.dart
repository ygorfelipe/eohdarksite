...
class ProjectDetailsTablet extends StatefulWidget {
  final int projectId;
  const ProjectDetailsTablet({
    Key? key,
    required this.projectId,
  }) : super(key: key);

  @override
  State<ProjectDetailsTablet> createState() => _ProjectDetailsTabletState();
}

class _ProjectDetailsTabletState extends State<ProjectDetailsTablet> {
