...
class AboutPageTablet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    double fontTitle = 25.0;
    const double fontContent = 20;
          ...
          children: [
            ...
            Padding(
              padding: EdgeInsets.only(
                  left: context.percentHeight(0.1),
                  top: context.percentHeight(0.07),
                  right: context.percentHeight(0.1),
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    const CustomText(label: develop, fontSize: fontContent),
...
const String academic =
    'Formado em Análise e Desenvolvimento de Sistemas - Faculdade de Tecnologia (FATEC) - Prof. Antônio Belizandro Barbosa Rezende - Itapetininga - SP - 06/2023';
const String skills =
